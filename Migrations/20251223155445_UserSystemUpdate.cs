...
{
    /// <inheritdoc />
    public partial class UserSystemUpdate : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"
                SET @index_exists = (SELECT COUNT(*) FROM information_schema.STATISTICS 
                    WHERE table_schema = 'BlogDb' AND table_name = 'BlogPosts' AND index_name = 'IX_BlogPosts_UserId');
            ...
            migrationBuilder.Sql(@"
                SET @fk_exists = (SELECT COUNT(*) FROM information_schema.TABLE_CONSTRAINTS 
                    WHERE CONSTRAINT_SCHEMA = 'BlogDb' AND CONSTRAINT_NAME = 'FK_BlogPosts_Users_UserId');
